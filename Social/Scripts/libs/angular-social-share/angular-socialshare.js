    ...
    return {
      ...
      'link': function linkingFunction($scope, element, attr) {
        ...
        $scope.vkShare = function manageVkShare(data) {
          ...
          var urlString = 'https://www.vk.com/share.php?url=' + encodeURIComponent(data.url || $location.absUrl());

          if (data.title) {
            urlString += '&title=' + encodeURI(data.title);
          }

          if (data.text) {
            urlString += '&description=' + encodeURI(data.text);
          }
