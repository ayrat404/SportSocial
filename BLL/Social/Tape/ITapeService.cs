    ...
    public class TapeService : ITapeService
    {
        ...
        public PagedListVm<TapeVm> GetTape(int page, int count)
        {
            ...
            var result = _repository.Queryable<DAL.DomainModel.Tape>()
                ...
                .Include(t => t.Journal.RatingEntites.Select(r => r.User.Profile))
                .Include(t => t.Journal.User)
                .Include(t => t.Journal.User.Profile)
                ...
                .Include(t => t.Achievement.User.Profile)
                //.Include(t => t.Achievement.RatingEntites)
                //.Include(t => t.Achievement.RatingEntites.Select(r => r.User))
                //.Include(t => t.Achievement.RatingEntites.Select(r => r.User.Profile))
